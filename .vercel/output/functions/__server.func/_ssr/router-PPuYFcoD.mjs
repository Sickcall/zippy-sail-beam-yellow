...
import { t as Route$7 } from "../_campaignId-DhYJMMbZ.mjs";
import { $ as encode, $t as runWithTransaction, A as jwtVerify, At as email, C as toResponse, Cn as isDevelopment, Dt as array, E as base64Url, Et as any, Ft as optional, Gt as ATTR_HOOK_TYPE, It as record, Jt as safeJSONParse, Kt as ATTR_OPERATION_ID, Lt as string, Mt as looseObject, Nt as number, O as decodeJwt, Ot as boolean, Pt as object, Qt as runWithAdapter, Rt as unknown, S as serializeSignedCookie, Tn as isTest, Tt as _enum, Ut as withSpan, Wt as ATTR_CONTEXT, Xt as getCurrentAdapter, Yt as getAuthTables, Zt as queueAfterTransactionHook, _ as runWithRequestState, _n as logger, a as createAuthorizationURL, b as createRouter$1, bn as env, c as createRateLimitKey, d as deprecate, dn as APIError, dt as JWTExpired, en as getBetterAuthVersion, f as createAuthEndpoint, fn as BetterAuthError, g as hasRequestState, gn as createLogger, h as defineRequestState, i as refreshAccessToken, in as createRandomStringGenerator, jt as literal, k as decodeProtectedHeader, kt as discriminatedUnion, l as findInvalidTrustedProxies, m as isAPIError, mn as BASE_ERROR_CODES, n as socialProviders, nn as initGetFieldName, o as applyDefaultAccessTokenExpiry, p as createAuthMiddleware, pn as kAPIErrorHeaderSymbol, qt as import_src, r as validateAuthorizationCode, rn as generateId, s as isLoopbackHost, sn as betterFetch, t as SocialProviderListEnum, tn as initGetModelName, u as getIp, un as normalizePathname, v as getCurrentAuthContext, vn as shouldPublishLog, w as filterOutputFields, wn as isProduction, x as serializeCookie, y as runWithEndpointContext } from "../_libs/@better-auth/core+[...].mjs";
...
import { t as Route$8 } from "../_campaignId-tmtvaDhj.mjs";
import { t as Route$9 } from "../_campaignId-BNSyio35.mjs";
import { t as Toaster } from "../_libs/sonner.mjs";
import { t as Route$10 } from "../_code-MCKm2RcP.mjs";
import { t as Route$11 } from "./join-43zGEkp1.mjs";
...
import { n as number$1, r as string$1, t as boolean$1 } from "../_libs/zod.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/router-PPuYFcoD.js
...
var styles_default = "/assets/styles-Pr7jlEaW.css";
var APP_NAME = "Grimoire";
var APP_DESCRIPTION = "Run homebrew D&D campaigns with scene guides, skill challenges, and table tools.";
...
function RootComponent() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("html", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("head", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(HeadContent, {}) }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("body", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(AuthProvider, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(TooltipProvider, {
			delayDuration: 250,
			children: [
...
var $$splitComponentImporter$2 = () => import("./routes-D-DGV7-5.mjs");
var Route$5 = createFileRoute("/")({ component: lazyRouteComponent($$splitComponentImporter$2, "component") });
var $$splitComponentImporter$1 = () => import("./login-DWFc-oYy.mjs");
...
function createNeonSql() {
	globalRef$2.__pgSqlPromise__ ??= (async () => {
		...
		globalRef$2.__pgSqlPromise__ = void 0;
		throw err;
	});
	return globalRef$2.__pgSqlPromise__;
}
async function createPgliteSql() {
	globalRef$2.__pgliteInstance__ ??= (async () => {
		...
		globalRef$2.__pgliteInstance__ = void 0;
		throw err;
	});
	const pg = await globalRef$2.__pgliteInstance__;
	const migrate = async () => {
	...
	const pass = (globalRef$2.__pgliteMigrateChain__ ?? Promise.resolve()).catch(() => void 0).then(migrate);
	globalRef$2.__pgliteMigrateChain__ = pass;
	await pass;
	return toSql(async (text, params) => {
...
function ensureSchema$1(sql) {
	globalRef$1.__rtcSchemaPromise__ ??= (async () => {
		...
		globalRef$1.__rtcSchemaPromise__ = void 0;
		throw err;
	});
	return globalRef$1.__rtcSchemaPromise__;
}
...
async function handleSignaling(request) {
	try {
		...
		return json$1({ error: "signaling failed" }, 500);
	}
}
var handle$1 = ({ request }) => handleSignaling(request);
...
*/
var CODE = string().regex(/^[A-Z0-9]{4,12}$/);
var globalRef = globalThis;
function ensureSchema(sql) {
	globalRef.__tableSchemaPromise__ ??= (async () => {
		await sql.query(`CREATE TABLE IF NOT EXISTS table_rooms (
         code TEXT PRIMARY KEY,
         state JSONB NOT NULL,
         version INT NOT NULL DEFAULT 1,
         updated_at TIMESTAMPTZ NOT NULL DEFAULT now()
       )`);
		await sql.query(`CREATE TABLE IF NOT EXISTS table_actions (
         id BIGSERIAL PRIMARY KEY,
         code TEXT NOT NULL,
         payload JSONB NOT NULL,
         created_at TIMESTAMPTZ NOT NULL DEFAULT now()
       )`);
		await sql.query(`CREATE INDEX IF NOT EXISTS table_actions_inbox ON table_actions (code, id)`);
	})().catch((err) => {
		globalRef.__tableSchemaPromise__ = void 0;
		throw err;
	});
...
async function handleTableRelay(request) {
	try {
		...
		if (request.method === "GET") {
			...
			if (Math.random() < .05) await sql.query(`DELETE FROM table_actions WHERE created_at < now() - interval '10 minutes'`);
			const rows = await sql.query(`SELECT state, version FROM table_rooms WHERE code = $1`, [code]);
			if (!rows[0]) return json({
				state: null,
				version: 0,
				actions: []
			});
			const actions = await sql.query(`SELECT id, payload FROM table_actions WHERE code = $1 AND id > $2 ORDER BY id LIMIT 100`, [code, since]);
			return json({
		...
		if (request.method === "POST") {
			...
			if (op === "put") {
				...
				if (JSON.stringify(state).length > 4e5) return json({ error: "state too large" }, 400);
				await sql.query(`INSERT INTO table_rooms (code, state, version, updated_at)
           ...
           ON CONFLICT (code) DO UPDATE SET
			...
			if (op === "action") {
				...
				if (JSON.stringify(payload).length > 32768) return json({ error: "payload too large" }, 400);
				await sql.query(`INSERT INTO table_actions (code, payload) VALUES ($1, $2::jsonb)`, [code, JSON.stringify(payload)]);
				return json({ ok: true });
			}
			if (op === "ack") {
				const code = String(body.code ?? "").toUpperCase();
...
var handle = ({ request }) => handleTableRelay(request);
var Route$2 = createFileRoute("/api/table")({ server: { handlers: {
	GET: handle,
	POST: handle
} } });
var $$splitComponentImporter = () => import("./library-Cq92JGym.mjs");
var Route$1 = createFileRoute("/library/")({ component: lazyRouteComponent($$splitComponentImporter, "component") });
...
var ApiTableRoute = Route$2.update({
	id: "/api/table",
	path: "/api/table",
	getParentRoute: () => Route$6
});
var CampaignCampaignIdRoute = Route$7.update({
...
var rootRouteChildren = {
	...
	LibraryCampaignIdRoute: Route$9.update({
		id: "/library/$campaignId",
		path: "/library/$campaignId",
		getParentRoute: () => Route$6
	}),
	RunCampaignIdRoute: Route$8.update({
		id: "/run/$campaignId",
		path: "/run/$campaignId",
		getParentRoute: () => Route$6
	}),
	TableCodeRoute: Route$10.update({
		id: "/table/$code",
		path: "/table/$code",
		getParentRoute: () => Route$6
	}),
