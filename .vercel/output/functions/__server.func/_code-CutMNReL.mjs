...
import { B as Copy, C as Package, D as Map$1, F as Eye, I as EyeOff, M as Heart, P as Gift, R as Dices, V as ChevronRight, W as BookOpen, _ as ScrollText, a as User, b as Plus, d as Swords, g as Send, h as Settings2, i as Users, k as LayoutGrid, l as Trash2, m as Share2, n as X, o as UserRound, p as Sparkles, r as Wrench, t as Zap, z as Crosshair } from "./_libs/lucide-react.mjs";
...
import { t as Route } from "./_code-MCKm2RcP.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/_code-CutMNReL.js
	...
	(0, import_react.useEffect)(() => {
		...
		const tick = async () => {
			...
			try {
				...
				const res = await fetch(`/api/table?code=${encodeURIComponent(code)}&since=${since}`);
				if (res.ok) {
					...
					if (!isDm && Math.random() < .05) postAction({
						t: "hello",
						role: "player",
						name: opts.displayName,
						peerId: selfId
...
function TablePage() {
	...
	if (!session.joined || !session.ready && role === "player") return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					...
					children: "Connecting to table…"
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "mt-1 text-sm text-[var(--color-fg-muted)]",
					children: role === "player" ? "Waiting for the DM to share the table." : "Opening your DM channel."
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "mt-4 font-mono text-xs tracking-widest text-[var(--color-steel)]",
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
							...
							variant: "secondary",
							onClick: copyInvite,
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Share2, { className: "size-3.5" }), "Invite"]
						})
					]
				})
			}),
